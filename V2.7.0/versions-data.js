...
const VERSIONS_DATA = {
    ...
    history: [
        ...
        },
        {
            version: "V2.6.1",
            date: "2026-03-08",
            title: "Système de versions automatique",
            type: "new",
            changes: [
        ...
        },
        {
            ...
            type: "update",
            changes: [
                "👥 Ajout des comptes Karen et Martin",
                "🔒 Système de statuts (bloqué/actif)",
    ...
    stats: {
        ...
        lastUpdate: function() {
            return this.history[0]?.date || "2026-03-09";
        },
