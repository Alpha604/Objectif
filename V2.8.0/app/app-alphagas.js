/**
 * app/app-karen.js - Application pour Karen Karapetyan
 */
...
(function() {
    function init() {
        ...
        // Palette spécifique à Karen (sera aussi appliquée par le CSS)
        const colors = COLOR_PALETTES['alphagas'];
            ...
            if (data.achievement && data.achievement.active) {
                bannerDiv.innerHTML = `
                    <div class="achievement-banner">
                        <i class="fas fa-crown" style="color: ${colors.primary};"></i>
